/* $Id: MenuPageSave.java,v 1.1 2004/01/27 20:11:53 tk1748 Exp $ */
package mud.trunk;
...
/**
  ...
  directory
 */
public class MenuPageSave extends MenuPage
{
    ...
    {
	new MenuTitle (this,myStage,"Select save slot");

	if (input.size() > 0)
	{
	    for (int i=0; i<input.size(); i++)  
	    {
		new MenuSave (this,myStage,((File)input.get(i)));
	    }
	}
	else
	{
	    new MenuItem (this,myStage,"Saving not available");
	}

	new MenuNavigator (this,myStage,"don't save",0);
    }
